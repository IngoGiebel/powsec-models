...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, breakable, frame hidden, interior hidden, sharp corners, boxrule=0pt, enhanced]}{\end{tcolorbox}}\fi
...
ETH as complements or substitutes.
...
adoption through incumbent gatekeepers, creating a Nash equilibrium
where banks profit from Bitcoin's success while retaining the option to
advocate for restrictive regulation if self-custody adoption threatens
...
small enough not to threaten monetary sovereignty. This creates a
game-theoretic equilibrium where certain state actors simultaneously
\emph{regulate} Bitcoin publicly while \emph{utilize} its surveillance
properties covertly, a dual-use dynamic with no stable endpoint.
